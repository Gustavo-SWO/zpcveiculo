					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Visualizar/Manter Veículo",
									"targetURL": "#zpcveiculo-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zpcveiculo-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpcveiculo",
									"url": sap.ui.require.toUrl("zpcveiculo")
								}
							}
						}
					}
